...
export async function action({ request }: Route.ActionArgs) {
  await requireAdminMutation(request, ADMIN_PERMISSIONS.SEO, "seo");
  const fd = await request.formData();
  const intent = fd.get("intent") as string;

  const save = (key: string) =>
    upsertSetting(key, (fd.get(key) as string) ?? "");
...
export default function AdminSeoSettingsPage({
  ...
  const [meta, setMeta] = useState({
    ...
    [SETTING_KEYS.SEO_DESCRIPTION]:
      settings[SETTING_KEYS.SEO_DESCRIPTION] ?? "",
    ...
    [SETTING_KEYS.SEO_ROBOTS]:
      settings[SETTING_KEYS.SEO_ROBOTS] ?? "index,follow",
  });

  // 검색엔진 인증
  const [verification, setVerification] = useState({
    [SETTING_KEYS.SEO_GOOGLE_VERIFICATION]:
      settings[SETTING_KEYS.SEO_GOOGLE_VERIFICATION] ?? "",
    [SETTING_KEYS.SEO_NAVER_VERIFICATION]:
      settings[SETTING_KEYS.SEO_NAVER_VERIFICATION] ?? "",
  });
  ...
  const [htmlMeta, setHtmlMeta] = useState({
    ...
    [SETTING_KEYS.SEO_META_AUTHOR]:
      settings[SETTING_KEYS.SEO_META_AUTHOR] ?? "",
        ...
        <div className="flex-1 overflow-auto p-8">
          ...
          <div className="max-w-2xl space-y-8">
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center gap-2">
                  <Globe className="h-5 w-5 text-[#204E3A]" />
                ...
                >
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setMeta({
                          ...meta,
                          [SETTING_KEYS.SEO_SITE_NAME]: e.target.value,
                        })
                      }
                      placeholder="풍림푸드"
                    />
                    <p className="text-xs text-gray-400">
                      브라우저 탭과 검색결과 제목 끝에 붙는 이름입니다.
                    </p>
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Textarea
                      ...
                      onChange={(e) =>
                        setMeta({
                          ...meta,
                          [SETTING_KEYS.SEO_DESCRIPTION]: e.target.value,
                        })
                      }
                    ...
                    <p className="text-xs text-gray-400">
                      ...
                      <span className="ml-1 text-gray-500">
                        ({meta[SETTING_KEYS.SEO_DESCRIPTION].length}/160)
                      </span>
                    </p>
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <ImageUpload
                      ...
                      onChange={(url) =>
                        setMeta({ ...meta, [SETTING_KEYS.SEO_OG_IMAGE]: url })
                      }
                    ...
                    <p className="text-xs text-gray-400">
                      비워두면 기본 이미지(
                      <code className="text-[11px]">/og/share.png</code>)가
                      사용됩니다. 카카오·페이스북 등은 1.91:1 비율로 크롭하므로
                      로고 주변에 충분한 여백이 필요합니다.
                    </p>
                    <Input
                      value={meta[SETTING_KEYS.SEO_OG_IMAGE]}
                      onChange={(e) =>
                        setMeta({
                          ...meta,
                          [SETTING_KEYS.SEO_OG_IMAGE]: e.target.value,
                        })
                      }
                    ...
                    {meta[SETTING_KEYS.SEO_OG_IMAGE] && (
                      <img
                        ...
                        alt="OG 미리보기"
                        className="mt-1 aspect-[1200/630] w-full max-w-sm rounded-lg border object-cover"
                      />
                    )}
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setMeta({
                          ...meta,
                          [SETTING_KEYS.SEO_SITE_URL]: e.target.value,
                        })
                      }
                      placeholder="https://www.poonglimfood.co.kr"
                    />
                    <p className="text-xs text-gray-400">
                      canonical URL 및 OG url 기본값으로 사용됩니다.
                    </p>
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        setMeta({ ...meta, [SETTING_KEYS.SEO_ROBOTS]: v })
                      }
                    >
                      <SelectTrigger>
                        <SelectValue />
                  ...
                  <div className="flex items-center gap-3 pt-2">
                    ...
                    >
                      {isSaving &&
                      fetcher.formData?.get("intent") === "save_meta"
                        ? "저장 중..."
                        : "저장"}
                    </Button>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  ...
                  에 출력되는 viewport·keywords·author 등입니다. 비우면 기본값
                  또는 태그 생략입니다.
                </CardDescription>
              </CardHeader>
              <CardContent>
                ...
                >
                  ...
                  <div className="space-y-1.5">
                    ...
                    <p className="text-xs text-gray-400">
                      ...
                      메타와 중복될 수 있습니다. 특별히 필요할 때만 입력하세요.
                      비우면 태그를 넣지 않습니다.
                    </p>
                  </div>
                  ...
                  <div className="flex items-center gap-3 pt-2">
                    ...
                    >
                      {isSaving &&
                      fetcher.formData?.get("intent") === "save_html_meta"
                        ? "저장 중..."
                        : "저장"}
                    </Button>
                    <SavedBadge
                      show={!isSaving && savedSection === "html_meta"}
                    />
                  </div>
                </form>
              </CardContent>
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center gap-2">
                  <Search className="h-5 w-5 text-[#204E3A]" />
                  <CardTitle>검색엔진 인증</CardTitle>
                </div>
                <CardDescription>
                  Google Search Console 및 네이버 웹마스터 도구 소유권 인증
                  코드입니다.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <form
                  onSubmit={(e) => {
                    e.preventDefault();
                    submit("save_verification", verification);
                  }}
                  className="space-y-5"
                >
                  <div className="space-y-1.5">
                    ...
                    />
                    <p className="text-xs text-gray-400">
                      Search Console → 속성 추가 → HTML 태그 방식의{" "}
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setVerification({
                          ...verification,
                          [SETTING_KEYS.SEO_NAVER_VERIFICATION]: e.target.value,
                        })
                      }
                      placeholder="예: abcdef1234567890abcdef1234567890"
                    />
                    <p className="text-xs text-gray-400">
                      네이버 서치어드바이저 → 사이트 등록 → HTML 태그의{" "}
                      <code className="rounded bg-gray-100 px-1">content</code>{" "}
                      값만 입력하세요.
                    </p>
                  </div>
                  ...
                  <div className="flex items-center gap-3 pt-2">
                    ...
                    <SavedBadge
                      show={!isSaving && savedSection === "verification"}
                    />
                  </div>
                </form>
              </CardContent>
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center gap-2">
                  <BarChart2 className="h-5 w-5 text-[#204E3A]" />
              ...
              <CardContent>
                <form
                  onSubmit={(e) => {
                    e.preventDefault();
                    submit("save_analytics", analytics);
                  }}
                  className="space-y-5"
                >
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setAnalytics({
                          ...analytics,
                          [SETTING_KEYS.SEO_GA_ID]: e.target.value,
                        })
                      }
                      placeholder="G-XXXXXXXXXX 또는 GTM-XXXXXXX"
                    />
                    <p className="text-xs text-gray-400">
                      <span className="font-medium text-gray-600">직연동:</span>{" "}
                      GA4 데이터 스트림 측정 ID (
                      ...
                      컨테이너 ID (
                      <code className="rounded bg-gray-100 px-1">GTM-</code>) —
                      GTM 안에서 GA4 태그만 켜면 되고,{" "}
                      <code className="rounded bg-gray-100 px-1">G-</code>는 이
                      칸에 넣지 마세요(중복 수집 방지).
                    </p>
                  </div>
                  ...
                  <div className="flex items-center gap-3 pt-2">
                    ...
                    <SavedBadge
                      show={!isSaving && savedSection === "analytics"}
                    />
                  </div>
                </form>
              </CardContent>
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center gap-2">
                  <ImageIcon className="h-5 w-5 text-[#204E3A]" />
              ...
              <CardContent>
                ...
                >
                  ...
                  <div className="flex items-center gap-3 pt-2">
                    ...
                    <SavedBadge
                      show={!isSaving && savedSection === "favicon"}
                    />
                  </div>
                </form>
              </CardContent>
